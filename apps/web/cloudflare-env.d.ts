/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 2ba782c51b29a757da9a7c2f2b7b9034)
// Runtime types generated with workerd@1.20260603.1 2026-06-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	BEAT_UPLOADS: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	REALTIME_WS_URL: "wss://rap-realtime.raparena.workers.dev";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REALTIME_WS_URL" | "NEXTJS_ENV" | "OPENROUTER_API_KEY" | "OPENROUTER_STT_MODEL" | "JWT_SECRET" | "BACKOFFICE_PASSWORD">> {}
}
